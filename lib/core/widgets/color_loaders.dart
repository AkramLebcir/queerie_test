            ...
            child: Stack(
              children: <Widget>[
                ...
                Transform.translate(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<CustomColors>()?.red ?? Colors.red,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<CustomColors>()?.yellow ?? Colors.yellow,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<CustomColors>()?.green ?? Colors.green,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<CustomColors>()?.flamingo ?? Colors.pink,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<CustomColors>()?.lavender ?? Colors.purple,
                  ),
                ),
                Transform.translate(
                  offset: Offset(
                  ...
                  child: Dot(
                    radius: dotRadius,
                    color: Theme.of(context).extension<CustomColors>()?.pink ?? Colors.pinkAccent,
                  ),
                ),
              ],
            ),
